...
public static class L
{
    ...
    private static readonly Dictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        // ---- Düello ----
        {"ikiniz de misketlerinizi ortaya koyun, sırayla atın,\nçıkardığınız misket sizin olur", "both put your marbles in the ring, take turns,\nwhat you knock out is yours"},
        {"Kese {0} misket · her el {1}'er ortaya", "Pouch {0} marbles · {1} each into the ring per round"},
        {"Çıkardığın misket kesene girer", "Marbles you knock out go into your pouch"},
        {"Çıkardıysan tekrar atarsın, turda en fazla {0}", "Knock one out and you shoot again, up to {0} per turn"},
        {"Atıcın çemberin ortasında kalırsa onu kaybedersin", "If your shooter stops in the middle of the ring you lose it"},
        {"Maç başı sıra atışı: kenara yakın duran önce atar", "Opening lag: whoever stops closest to the edge shoots first"},
        {"Herkes aynı misketi kullanır, güç yok", "Everyone uses the same marble, no powers"},
        {"AYNI CİHAZDA OYNA · İki kişi tek telefonda", "PLAY ON ONE DEVICE · Two players, one phone"},
        {"yuvarlak saha", "round field"}, {"sivri uç, dar açılar", "sharp corners, tight angles"},
        {"tek sıra · kıpırdattığın senin", "one row · what you move is yours"},
        {"ortada çukur · düşürdüğün senin", "hole in the middle · what you sink is yours"},
        {"ODA KUR", "CREATE ROOM"}, {"Oda kurma henüz hazır değil.", "Creating rooms isn't ready yet."},
        {"ODAYA KATIL", "JOIN ROOM"}, {"Odaya katılma henüz hazır değil.", "Joining rooms isn't ready yet."},
        {"Sahanın UZAK kenarına en yakın duran önce atar · çizgiyi geçen yanar", "Closest to the FAR edge shoots first · crossing the line is a foul"},
        {"MAÇA BAŞLA", "START MATCH"}, {"{0} ÖNCE ATIYOR", "{0} SHOOTS FIRST"}, {"{0} misketlerini önce dizer", "{0} places marbles first"},
        {"RAKİP ATIYOR", "RIVAL SHOOTING"}, {"{0} ATIYOR", "{0} SHOOTING"},
        {"Rakibinden daha yakın durdurmaya çalış", "Try to stop closer than your rival"},
        {"Uzak kenara olabildiğince yakın durdur", "Stop as close to the far edge as you can"},
        {"Misketlerini kendi elinle dizmek ister misin?", "Do you want to place your marbles yourself?"},
        {"Bu hakkı maç boyunca bir kez kullanabilirsin", "You can use this once per match"},
        {"ELLE DİZECEĞİM", "I'LL PLACE THEM"}, {"OTOMATİK DİZİLSİN", "AUTO PLACE"},
        {"EL {0}", "ROUND {0}"}, {"EL {0} / {1}", "ROUND {0} / {1}"}, {"EL {0} BİTTİ", "ROUND {0} OVER"},
        {"Sahanın içine dokunarak misketlerini diz. Rakibin dizilişini görmüyorsun.", "Tap inside the field to place your marbles. You can't see your rival's layout."},
        {"GERİ AL", "UNDO"}, {"HAZIR DİZİLİŞ", "PRESET"}, {"HAZIRIM", "READY"},
        {"{0} / {1} misket dizildi", "{0} / {1} marbles placed"}, {"Hazırsan HAZIRIM'a bas", "Tap READY when you're set"},
        {"{0} misket daha koy", "Place {0} more"},
        {"TELEFONU VER", "PASS THE PHONE"}, {"{0} şimdi kendi misketlerini dizecek", "{0} will now place their marbles"},
        {"Diziliş gizli: kimse diğerinin nereye koyduğunu görmeyecek", "Layouts are hidden: nobody sees where the other placed"},
        {"Önce çukura gir (PİŞ), sonra rakibi sahadan çıkar · 3 turdan 2'sini alan kazanır", "First roll into the hole (ARM UP), then knock your rival out · best of 3 rounds wins"},
        {"KUYU", "HOLE"}, {"{0} tur", "{0} rounds"}, {"TUR {0} / {1}", "ROUND {0} / {1}"},
        {"Bu turda {0} atış hakkın daha var", "{0} more shots this turn"},
        {"Piştin: rakibi sahadan çıkar, tur senin", "You're armed: knock your rival out to win the round"},
        {"Önce çukura gir", "Roll into the hole first"},
        {"TUR İPTAL", "ROUND CANCELLED"}, {"{0} TURU ALDI", "{0} WINS THE ROUND"},
        {"Dört tur üst üste kimse bir şey yapamadı, tur baştan başlıyor", "Nobody scored for four turns, the round restarts"},
        {"TEKRAR", "AGAIN"}, {"SONRAKİ TUR", "NEXT ROUND"}, {"{0} KAZANDI", "{0} WINS"}, {"RÖVANŞ", "REMATCH"},
        {"ilk atan değişir", "first shooter switches"}, {"ilk dizen değişir", "first placer switches"},
        {"Çıkardığın misket senin · atıcın çemberin ORTASINDA kalırsa kaybedersin", "What you knock out is yours · lose your shooter if it stops in the MIDDLE"},
        {"Sıranı bekle · çemberde {0} misket", "Wait your turn · {0} in the ring"}, {"Çemberde {0} misket", "{0} in the ring"},
        {"Çemberde kalan {0} misket sonraki ele devrediyor", "{0} marbles left in the ring carry over to the next round"},
        {"kesedeki misket", "marbles in pouch"}, {"BERABERE", "DRAW"}, {"SONRAKİ EL", "NEXT ROUND"},
        {"Kurallar", "Rules"},
        {"1. OYUNCU", "PLAYER 1"}, {"2. OYUNCU", "PLAYER 2"}, {"SEN", "YOU"}, {"RAKİP", "RIVAL"},
        {"ÇEMBER", "RING"}, {"ÜÇGEN", "TRIANGLE"}, {"DİZİ", "ROW"},
        {"PİŞTİ", "ARMED"}, {"ÇİĞ", "NOT ARMED"}, {"{0} PİŞTİ", "{0} IS ARMED"},
        {"Çukura tekrar girdi", "Rolled into the hole again"},
        {"Pişmeden çıkardı · rakip çizgiye döndü", "Knocked out before arming · rival back to the line"},
        {"Sahadan çıktı", "Left the field"}, {"Vurdu ama çıkaramadı", "Hit but didn't knock out"},
        {"YANDI", "FOUL"},
