...
public static class L
{
    ...
    private static readonly Dictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        {"REKOR {0}", "BEST {0}"}, {"YENİ MOD", "NEW MODE"}, {"TUR {0}", "ROUND {0}"},
        {"REKOR: {0}", "BEST: {0}"}, {"REKOR: {0} · HER ÇIKAN MİSKET BİR ATIŞ KAZANDIRIR", "BEST: {0} · EVERY MARBLE OUT EARNS A SHOT"},
        {"YENİ REKOR!", "NEW BEST!"}, {"SÜRE DOLDU", "OUT OF SHOTS"}, {"misket çıkardın", "marbles knocked out"},
