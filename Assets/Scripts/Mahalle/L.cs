...
public static class L
{
    ...
    private static readonly Dictionary<string, string> En = new Dictionary<string, string>
    {
        ...
        {"HARİTALAR", "MAPS"},
        {"YENİ", "NEW"}, {"KUM", "SAND"}, {"ÇAMUR", "MUD"}, {"EĞİM", "SLOPE"}, {"BUZLU MİSKET", "ICE MARBLE"},
        {"KARPUZ MİSKET", "WATERMELON MARBLE"}, {"ÇUKUR", "PIT"},
        {"Kumun içinden geçen misket çabuk yavaşlar. Kumun ötesine ulaşmak için sert at.", "Marbles slow down fast in sand. Shoot hard to get past it."},
        {"Çamura giren misket saplanıp kalır. Hedefleri çamura değil, çemberin dışına it.", "A marble that rolls into mud gets stuck. Push targets out of the ring, not into the mud."},
        {"Burası yokuş: yuvarlanan misketler okların gösterdiği yöne kayar. Yavaş misket daha çok kayar.", "This is a slope: rolling marbles drift the way the arrows point. Slow marbles drift more."},
        {"Buzlu misket kıpırdamaz. Önce sert bir atışla buzunu kır, sonra dışarı çıkar. Hafif vuruş işe yaramaz.", "An ice marble won't budge. Break its ice with a hard shot first, then knock it out. Soft hits do nothing."},
        {"Sert vurursan ikiye bölünür. İki yarısı birlikte 1 misket sayılır: ikisini de çemberin dışına çıkar.", "Hit it hard and it splits in two. Both halves together count as 1 marble: knock both out of the ring."},
        {"Yavaş yuvarlanan misket çukura düşer ve kaybolur, sayılmaz. Hızlı misket çukurun üstünden geçer.", "A slow marble falls into the pit and is lost, it doesn't count. A fast marble rolls over it."}, {"BURADASIN", "YOU ARE HERE"}, {"{0} / {1} yıldız", "{0} / {1} stars"},
        {"Her haritanın kendi 60 bölümü var. Dokun, geç.", "Each map has its own 60 levels. Tap to switch."},
        {"{0} haritasını bitir, bu harita açılsın.", "Finish {0} to open this map."},
        {"{0} açıldı! Haritalar'dan geçebilirsin.", "{0} is open! Switch from Maps."},
        {"{0} TAMAMLANDI", "{0} COMPLETE"},
